...
export class Carousel {
  ...
  constructor(options) {
    ...
    this.slides = this.container.querySelectorAll(".slides " + settings.slideId)
  ...
  #createControls() {
    ...
    this.pauseBtn.className = "control-btn"
    ...
    this.prevBtn.className = "control-btn"
    this.prevBtn.innerHTML = '<i class="fas fa-backward"></i>'

    this.nextBtn = document.createElement("button")
    this.nextBtn.id = "next-btn"
    this.nextBtn.className = "control-btn"
    this.nextBtn.innerHTML = '<i class="fas fa-forward"></i>'
